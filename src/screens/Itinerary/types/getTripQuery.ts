...
export type GetTripQuery = { node?: Types.Maybe<{ __typename: 'Activity', id: string } | { __typename: 'Invitation', id: string } | { __typename: 'Trip', createdAt: any, name: string, description?: Types.Maybe<string>, id: string, admin: { id: string, displayName: string, username: string }, members: Array<{ role: Types.TripUserRole, color: string, user: { id: string, displayName: string, username: string } }>, itinerary: Array<{ id: string, latitude?: Types.Maybe<number>, longitude?: Types.Maybe<number>, name?: Types.Maybe<string>, previousTripRoutePoint?: Types.Maybe<{ name?: Types.Maybe<string> }>, nextTripRoutePoint?: Types.Maybe<{ name?: Types.Maybe<string> }>, activities: Array<{ id: string, name: string, description?: Types.Maybe<string>, startDate?: Types.Maybe<string>, endDate?: Types.Maybe<string>, routePoint: { id: string, name?: Types.Maybe<string> }, addedByUser: { id: string, username: string, displayName: string } }> }> } | { __typename: 'TripMember', id: string } | { __typename: 'TripRoutePoint', id: string } | { __typename: 'User', id: string }> };
